...
<div class="user-sidebar" id="user-sidebar">
    <div id="sidebar-close" class="fas fa-times" style="font-size: 2.5rem; cursor: pointer; position: absolute; top: 20px; right: 20px;"></div>
...
?>
            <img src="<?php echo htmlspecialchars($profile_img); ?>" alt="Profile Picture" id="sidebar-profile-img" style="width: 100%; height: 100%; object-fit: cover;">
        </div>
    ...
    <div class="sidebar-nav" style="display: flex; flex-direction: column; gap: 10px; flex: 1; margin-bottom: 20px;">
        <a href="settings.php" class="nav-link <?php echo($current_page == 'settings.php') ? 'active' : ''; ?>" style="padding: 15px 20px; text-decoration: none; font-size: 1.5rem; display: flex; align-items: center; gap: 15px; border-radius: 8px;">
            <i class="fas fa-cog" style="font-size: 1.8rem; width: 25px; text-align: center;"></i> Account
        </a>
        <a href="my_bookings.php" class="nav-link <?php echo($current_page == 'my_bookings.php') ? 'active' : ''; ?>" style="padding: 15px 20px; text-decoration: none; font-size: 1.5rem; display: flex; align-items: center; gap: 15px; border-radius: 8px; font-weight: bold;">
            <i class="fas fa-book" style="font-size: 1.8rem; width: 25px; text-align: center;"></i> My Bookings
        </a>
        <a href="https://wa.me/+201014130237" class="nav-link" style="padding: 15px 20px; text-decoration: none; font-size: 1.5rem; display: flex; align-items: center; gap: 15px; border-radius: 8px;">
            <i class="fas fa-headset" style="font-size: 1.8rem; width: 25px; text-align: center;"></i> Support
        </a>
    </div>
    ...
    <?php
        ...
        <div class="profile-header" style="text-align: center; margin-top: 60px;">
            <h3 style="font-size: 1.8rem; margin-bottom: 10px;">Not Logged In</h3>
            <p style="font-size: 1.3rem; color: #555555;">Please log in to view your profile.</p>
        </div>
    <?php
endif; ?>
</div>
