...
?>
    <div style="background-color: #ff9800; color: white; text-align: center; padding: 12px; font-size: 1.4rem; font-weight: bold; position: sticky; top: 0; z-index: 9999; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
        <i class="fas fa-exclamation-triangle"></i> Please complete your profile by adding a phone number. 
        <a href="settings.php" style="color: #fff; text-decoration: underline; margin-left: 10px; padding: 4px 10px; background: rgba(0,0,0,0.2); border-radius: 4px;">Go to Settings</a>
    </div>
    <?php
   endif; ?>
<?php
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <div class="content">
            ...
            <h2>Eg 9,900</h2>
            <a href="book.php?p=Delhi%20Tour%20Package&price=9900" class="btn">book now</a>
         </div>
      </div>
      <div class="box">
         <div class="image">
