...
<head>
   ...
   <title>إعدادات الحساب :: وكاله سياحيه</title>
...
<section class="header">
   ...
   <div class="icons">
      <a href="../en/settings.php" class="fas fa-globe"></a>
...
<div class="settings-layout">
    ...
    <div class="settings-sidebar">
        ...
        <a href="#security" class="tab-link" data-target="pane-security"><i class="fas fa-shield-alt"></i> الامان</a>
    ...
    <div class="settings-content">
                ...
                <div class="settings-card">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="text" name="full_name" class="settings-input required-field" value="<?php echo htmlspecialchars($user_data['Full_name'] ?? ''); ?>" placeholder="ادخل اسمك الكامل">
                            <span class="error-msg">هذا الحقل مطلوب</span>
                        </div>
                        <div class="form-group">
                            <label>البريد الالكتروني</label>
                            <input type="email" name="email" class="settings-input required-field" value="<?php echo htmlspecialchars(strtolower($u_email)); ?>" placeholder="ادخل بريدك الالكتروني" style="text-transform: lowercase;">
                            <span class="error-msg">هذا الحقل مطلوب</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="settings-card">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="tel" name="phone" id="phone_number" class="settings-input required-field numeric-input" value="<?php echo htmlspecialchars($u_phone); ?>" placeholder="ادخل رقم الهاتف" dir="ltr" style="text-align: right;">
        ...
        <div id="pane-security" class="tab-pane" style="display: none;">
                ...
                <div class="settings-card">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <input type="password" name="password" id="new_password" class="settings-input required-field" placeholder="ادخل كلمة المرور الجديدة">
                            <span class="error-msg">هذا الحقل مطلوب</span>
                        </div>
                        <div class="form-group">
                            <label>تأكيد كلمة المرور</label>
                            <input type="password" name="confirm_password" id="confirm_password" class="settings-input required-field" placeholder="تأكيد كلمة المرور الجديدة">
                            <span class="error-msg">هذا الحقل مطلوب</span>
                        </div>
                    </div>
                    <div style="text-align: right;">
            ...
            <div class="settings-card" style="margin-top: 4rem;">
                ...
                <button type="button" class="btn-save" style="background: #0078f2; margin-top: 0;">تفعيل المصادقة الثنائية عبر الرسائل النصية</button>
            </div>

            <div class="settings-card" style="margin-top: 4rem;">
                <h3>سجل تسجيل الدخول</h3>
                <p style="font-size: 1.4rem; color: var(--settings-label); margin-bottom: 2rem;">الأجهزة والمواقع الحديثة التي تم تسجيل الدخول إلى حسابك.</p>
                <div style="border: 1px solid var(--settings-border); border-radius: 8px; overflow: hidden;">
                    <div style="padding: 1.5rem; border-bottom: 1px solid var(--settings-border); font-size: 1.4rem; color: var(--settings-text); display: flex; justify-content: space-between;">
                        ...
                        <span style="color: #2ecc71;">الجلسة الحالية</span>
                    </div>
...
<div class="unsaved-banner" id="unsavedBanner">
    <span>تنبيه — لديك تغييرات غير محفوظة!</span>
