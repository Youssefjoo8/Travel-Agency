...
?>
<style>
/* Deep Dark Theme for Sidebar (Arabic) */
#user-sidebar.user-sidebar {
    background-color: rgba(18, 18, 18, 0.95); /* Deep Black / Dark Gray semi-transparent */
    color: #ffffff !important;
    border-right: 1px solid #333333 !important; /* Changed to right border for RTL */
    border-left: none !important;
    display: flex;
    flex-direction: column;
    direction: rtl; /* Force RTL inside sidebar */
}
#user-sidebar * {
    color: #ffffff;
}
...
?>
    ...
    <div class="sidebar-nav" style="display: flex; flex-direction: column; gap: 10px; flex: 1; margin-bottom: 20px;">
        <!-- Links to arabic pages mapped correctly if they exist, else english fallback -->
        <a href="<?php echo $base_url; ?>/pages/ar/settings_ar.php" class="nav-link <?php echo($current_page == 'settings_ar.php' || $current_page == 'settings.php') ? 'active' : ''; ?>" style="padding: 15px 20px; text-decoration: none; font-size: 1.5rem; display: flex; align-items: center; gap: 15px; border-radius: 8px;">
            <i class="fas fa-cog" style="font-size: 1.8rem; width: 25px; text-align: center;"></i> إعدادات الحساب
        </a>
        <a href="<?php echo $base_url; ?>/pages/ar/bookings_ar.php" class="nav-link <?php echo($current_page == 'bookings_ar.php' || $current_page == 'my_bookings_arabic.php' || $current_page == 'my_bookings.php') ? 'active' : ''; ?>" style="padding: 15px 20px; text-decoration: none; font-size: 1.5rem; display: flex; align-items: center; gap: 15px; border-radius: 8px; font-weight: bold;">
        ...
        <a href="https://wa.me/+201014130237" class="nav-link" style="padding: 15px 20px; text-decoration: none; font-size: 1.5rem; display: flex; align-items: center; gap: 15px; border-radius: 8px;">
            <i class="fas fa-headset" style="font-size: 1.8rem; width: 25px; text-align: center;"></i> الدعم الفني
        </a>
    </div>
    ...
    <div class="profile-footer" style="padding-top: 20px; border-top: 1px solid #333333; margin-top: auto; position: static; background: transparent;">
        <a href="<?php echo $base_url; ?>/logout.php" class="btn logout-btn" style="display: block; width: 100%; padding: 15px; background-color: #e11d48 !important; text-align: center; text-decoration: none; font-size: 1.5rem; font-weight: bold; border-radius: 8px; border: none; transition: filter 0.3s;" onmouseover="this.style.filter='brightness(1.1)'" onmouseout="this.style.filter='none'">
    ...
    <?php
        ...
        <div class="profile-header" style="text-align: center; margin-top: 60px;">
            <h3 style="font-size: 1.8rem; margin-bottom: 10px;">غير مسجل الدخول</h3>
            <p style="font-size: 1.3rem; color: #555555;">يرجى تسجيل الدخول لعرض ملفك الشخصي.</p>
        </div>
    <?php
endif; ?>
</div>
