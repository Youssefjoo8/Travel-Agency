...
if (!isset($_SESSION['user_id']) || $_SESSION['user_type'] !== 'admin') {
   header("Location: ../pages/en/home.php");
   exit();
}
?>
<!DOCTYPE html>
...
<body>
   <div class="admin-container">
      <div class="header">
         ...
         <div class="user-info">
            <span>Welcome, <?php echo isset($_SESSION['user_name']) ? $_SESSION['user_name'] : $_SESSION['email']; ?></span>
            <a href="../logout.php" class="btn" style="margin-left: 1rem; background: var(--admin-text);">Logout</a>
         </div>
      </div>
